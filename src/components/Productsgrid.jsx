...
const Productsgrid = () => {
  ...
  return (
   ...
   px-5 py-[80px] bg-gray-100 flex flex-col
    justify-center items-center gap-4"
    >
      <h1
        data-aos="zoom-in"
        data-aos-delay="100"
        className="text-themepurple text-xl
         font-semibold"
      >
        Browse Collections
      </h1>
      <h1
        ...
        className="text-black font-semibold
         text-[42px] leading-[50px] text-center"
      >
        Trending Products
      </h1>
      <div
        data-aos="zoom-in"
        data-aos-delay="300"
        className="w-full grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-center items-center gap-10 mt-10"
      >
        {products.map((item, index) => (
          ...
          >
            ...
            <div className="w-full mt-2">
              <hr className="border-gray-200 font-semibold" />
